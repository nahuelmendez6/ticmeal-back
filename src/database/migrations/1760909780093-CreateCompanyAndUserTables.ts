...
export class CreateCompanyAndUserTables1760909780093 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_80b0c13a459e3185848ce63365\` ON \`companies\``);
